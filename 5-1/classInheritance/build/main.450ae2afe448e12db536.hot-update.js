...
class Chopper {
    ...
    bombMe() {
        this.bomb.dropMe(this._sprite.x + 25, this._sprite.y + 38);
    }
    positionMe(x, y) {
        this._sprite.x = x;
        this._sprite.y = y;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("596f66b175aac6544b3e")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.450ae2afe448e12db536.hot-update.js.map