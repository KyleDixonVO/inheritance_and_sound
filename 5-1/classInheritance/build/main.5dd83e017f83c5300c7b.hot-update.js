...
class Rocket extends Obstacle_1.Obstacle {
    ...
    update() {
        super.update();
        if ((Math.abs(this.chopper.sprite.x - this._sprite.x) <= 10) && (!createjs.Tween.hasActiveTweens(this._sprite)) && this.chopper.state != Chopper_1.Chopper.STATE_DEAD) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("573b8ebe6c95eb88d783")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.5dd83e017f83c5300c7b.hot-update.js.map